...
\only<2>{ \includegraphics[width=0.85\textwidth,page=4]{figuras/posterior_win.pdf}}
\end{textblock}
}
...
%     }
%     \only<8->{
%       \node[const, right=of fw2, yshift=0.6cm] (nfwt) {\normalsize$p(\bm{w}_{t+1}|\bm{w}_t,\bm{z}_t) = \N(\bm{w}_{t+1}|\bm{w}_t^T \Phi(\bm{z}_t), R )$ \ \  };
%     }
%
%
%
